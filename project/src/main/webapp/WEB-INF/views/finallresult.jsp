...
<body>
	...
	<div style="margin-top: 100px;">
		...
		<!-- 제목(결과) -->
		<div class="result">
			<h2 style="text-align: center;">님의 발음분석결과</h2>
			<br>
		</div>
		<div id="score">
			<h4 style="text-align: center;">점수확인</h4>
			<br>
			<br>
		</div>
		...
		<nav>
			...
			<ul class="style1">
				<li class="first">
					<p class="date">
						<i class="far fa-laugh-wink fa-3x" style="color: green;"></i>
					</p>
					<h3>ex)DAY1 > 1</h3>
					<p>
						ex)사과사과사과사과사과사과사과사과사과사과사과사과사과사과사과사과사과사과사과사과사과사과사과사과사과사과사과사과사과사과사과사과사과
					</p>
				</li>
				<li>
					<p class="date">
		...
		<div id="foo_btn" style="text-align: center;">
			<button type="button" class="btn btn-default" id="exit"
				onclick="exit()">나가기</button>
			&nbsp;&nbsp;&nbsp;&nbsp;
			<button type="button" class="btn btn-default" id="replay"
				onclick="replay()">반복하기</button>
		</div>
