			...
			<div class="container">
				<div class="row" style="margin-left: -32px;">
					<div class="off-8-small"
						style="margin-top: 20px; width: 50%; min-width: 349.5px;">
						<div class="panel panel-primary">
							<div id="chart_title" class="panel-heading">프로필</div>
							<div class="panel-body">
								<span>${vo.user_name}님</span><br> <span>${vo.user_birthdate}생년월일</span><br>
								<span>${vo.user_nationality}</span>
								<button type="button" class="btn btn-dark btn-block"
									style="width: 120px;">정보수정</button>
							</div>
						</div>
					</div>
					...
					<div class="row">
						...
						<div class="off-6-small">
							<div class="panel panel-primary">
								...
								<div class="panel-body">
									<canvas id="doughnut-chart3" width="300" height="250"></canvas>
									<script>
										new Chart(
												document
